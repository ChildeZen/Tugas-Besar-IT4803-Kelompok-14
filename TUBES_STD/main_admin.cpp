    ...
    while (option != 0) {
        ...
        case 7:
            ...
            if (subOption == 1) {
                ...
                string bidang;
                cout << "Cari Bidang: "; cin >> ws; getline(cin, bidang);
                // Jika ingin mencari SATU jurnalis di bidang tersebut
                P = findJurnalisByBidang(LJ, bidang); 
            } else if (subOption == 4) {
                string status;
